...
simulate = True  # logical whether to used simulated or real data (-> knowledge about real U's)
idX = 2  # specify graphon to consider (only used if simulate == True)
data_ = 'facebook'  # specify data to consider (only used if simulate == False), options: 'facebook', 'alliances', 'brain'
